...
1. Customer scans a used UNIQLO garment using the mobile app
2. AI analyzes the garment condition in real time
3. The system recommends repair, recycling, or buy-back
4. A digital voucher is issued to the customer
5. The voucher is redeemed on the next UNIQLO purchase
